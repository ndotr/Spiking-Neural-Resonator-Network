...
def init(SourceModule):
                          ...
                          float *params)
    {
        ...
        float alpha_u_rate = params[5];     // weight for potential, default: 0
        float u_rate_threshold = params[6]; // threshold
        float u_rate_rest = params[7];      // rest
        ...
        for (int t=0; t<n_samples; t++) {
            ...
            // Storing 
            if (debug==true) {
                states[state_idx + state_dim*n_samples*c + state_dim*t + 0] = u_rate;
